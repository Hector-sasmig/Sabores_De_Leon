...
public class GerenteVista extends JFrame implements ActionListener {
	...
	private void actualizarListaEmpleado(JPanel panelActualizado) {
		...
		for (EmpleadoVO empleado : empleados) {
			tableModel.addRow(new Object[] { empleado.getIdEmpleado(), empleado.getNombre(), empleado.getApellido(),
					empleado.getDni(), empleado.getTelefono(), empleado.getCorreo(), empleado.getTipo(),
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnCerrarSesion) {
			...
			this.gerenteControlador.eliminarMenu(id);
			id = -1;
